...
class DDPMSampler:
    def __init__(
        ...
        self.betas = torch.linspace(beta_start**0.5, beta_end**0.5, num_training_steps, dtypr=torch.float32)** 2
    ...
    def set_inference_timesteps(self, num_inference_steps=50):
        ...
        timesteps = (np.arange(0, num_inference_steps) * step_ratio).round()[::-1].copu().astype(np.int64)
    ...
    def _get_variance(self, timestep: int) -> torch.Tensor:
        ...
        # compute variance using formula (7)
    ...
    def set_strength(self, strength=1.0):
        start_step = self.num_training_steps - int(self.num_inference_steps * strength)
